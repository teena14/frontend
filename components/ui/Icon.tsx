// =============================================================================
// Icon — Inline SVG wrapper component
// Renders SVG icons inline (no external requests). All paths are from assets/svg.
// =============================================================================
...
// SVG path data for each icon from assets/svg
...
// ViewBox per icon (cube uses 0 0 16 16, search uses 0 0 20 20, rest use 0 0 24 24)
